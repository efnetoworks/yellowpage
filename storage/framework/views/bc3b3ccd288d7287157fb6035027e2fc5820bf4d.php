        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-4 col-sm-5">
                <ul class="list-inline top-header-links pull-right">
                    ...
                    <?php elseif(Auth::user()->role == 'cmo'): ?>
                    <a class="text-warning" href="<?php echo e(route('cmo.dashboard')); ?>"><i class="fa fa-user"></i> My Account</a>
                    <?php endif; ?>
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="mobile-top-navbar">
                <ul class="mbtn-links">
                    ...
                    <?php elseif(Auth::user()->role == 'cmo'): ?>
                    <a href="<?php echo e(route('cmo.dashboard')); ?>"> My Account</a>
                    <?php endif; ?>
                    <a href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault();
